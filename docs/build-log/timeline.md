...
| `2026-08-22T13:14:31+08:00` | Began simplifying the Railway architecture by replacing the dedicated polling Worker with request-triggered Next.js background work. | Git commit `07903ec`. |
| `2026-08-22T13:21:55+08:00` | Verified the new production Web deployment: readiness returned PostgreSQL and Redis healthy; one smoke redirect and 20 concurrent tracked redirects all returned HTTP 302, while PostgreSQL recorded the accumulated click and daily unique-estimate metrics. | Railway deployment `064c229e-27b8-4bba-a40e-acbd656258c0` and database verification. |
| `2026-08-22T13:23:35+08:00` | Deleted the redundant `striking-essence` Worker after production verification. The final Railway architecture contains one Web service, PostgreSQL, and Redis, all online. Architecture simplification elapsed time: `9m 04s`. | [`18-railway-three-services.jpg`](./screenshots/18-railway-three-services.jpg) |
